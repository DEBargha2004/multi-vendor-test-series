...
import { categories, languages } from "@/constants/test.utils";
import type { TMergedTest } from "@/schema/test";
...
export default function TestDetailsForm({
  ...
  form: ReturnType<typeof useForm<TMergedTest>>;
  onSubmit: (data: TMergedTest) => void;
  image?: TImageData;
  ...
  return (
    <Card className="md:w-1/3 md:min-w-[500px] w-full mt-10">
      <CardHeader>
